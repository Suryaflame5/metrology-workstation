...
Write-Host "[3/5] Creating README..." -ForegroundColor Yellow

$ReadmeContent = @"
# Metrology Workstation v$Version - Desktop Application
...
- Native desktop window with DPI awareness
...
- Desktop shortcut
- Start Menu
- Or directly: %LOCALAPPDATA%\$AppName\$AppExe
