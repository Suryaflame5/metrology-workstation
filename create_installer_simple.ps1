...
Write-Host "[3/6] Creating installation script..." -ForegroundColor Yellow
...
Write-Host "[4/6] Creating uninstaller..." -ForegroundColor Yellow
...
Write-Host "[5/6] Creating desktop shortcut sample..." -ForegroundColor Yellow

# Create a sample desktop shortcut
$WshShell = New-Object -ComObject WScript.Shell
$TempShortcut = $WshShell.CreateShortcut((Join-Path $InstallerDir "Desktop Shortcut.lnk"))
$TempShortcut.TargetPath = $AppExe
$TempShortcut.WorkingDirectory = "."
$TempShortcut.Description = "$AppName v$Version"
$TempShortcut.Save()
Write-Host "  ✓ Created desktop shortcut sample" -ForegroundColor Green
