...
INSTALLER_EXE_NAME = "Metrology-Workstation-v1.0.0-Windows-x64-Setup.exe"
...
def build_installer():
    print("=" * 70)
    print(" BUILDING METROLOGY WORKSTATION WINDOWS INSTALLER (v1.0.0)")
    print("=" * 70)
    ...
    cmd = [
        ...
        "-m",
        "PyInstaller",
        f"--name=Metrology-Workstation-v1.0.0-Windows-x64-Setup",
        "--onefile",
        "--noconfirm",
        "--clean",
