"""
Build Standalone Windows Setup Installer Executable (v1.0.0).
Uses PyInstaller to compile scripts/installer_runtime.py into Metrology-Workstation-v1.0.0-Windows-x64-Setup.exe.
"""
...
INSTALLER_EXE_NAME = "Metrology-Workstation-v6.0.0-Windows-x64-Setup.exe"
...
def build_installer():
    print("=" * 70)
    print(" BUILDING METROLOGY WORKSTATION WINDOWS INSTALLER (v6.0.0)")
    print("=" * 70)
    ...
    cmd = [
        ...
        "-m",
        "PyInstaller",
        f"--name=Metrology-Workstation-v6.0.0-Windows-x64-Setup",
        "--onefile",
        "--noconfirm",
        "--clean",
    ...
    if os.path.exists(built_installer):
        ...
        print(f" [OK] Wrote checksum manifest: {checksum_file}")
    else:
